...
Core.prototype._redraw = function() {
  ...
  props.border.top    = Math.floor((dom.centerContainer.offsetHeight - dom.centerContainer.clientHeight) / 2);
  ...
  if (resized) {
    if (this.redrawCount < MAX_REDRAW) {
      ...
      console.log('WARNING: infinite loop in redraw?', this.redrawCount);
    }
  } else {
    this.redrawCount = 0;
  }
